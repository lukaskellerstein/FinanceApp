...
from src.business.model.timeframe import Duration, TimeFrame
...
from src.ui.windows.asset_detail.shared.pages.history_chart.helpers import (
    fillGapsInDays,
    plotMonths,
    plotQuarters,
    plotSeasons,
...
from src.ui.windows.asset_detail.futures.pages.history_chart.helpers import (
    plotWeekends,
)
...
class FutureHistoryChartPage(BasePage):
    ...
    def __init__(self, **kwargs: Any):
        ...
        # load template
        uic.loadUi(
            "src/ui/windows/asset_detail/futures/pages/history_chart/history_chart.ui",
            self,
        )

        # load styles
        with open(
            "src/ui/windows/asset_detail/futures/pages/history_chart/history_chart.qss",
            "r",
        ) as fh:

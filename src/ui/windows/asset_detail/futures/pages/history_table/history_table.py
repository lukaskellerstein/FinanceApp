...
from src.ui.windows.main.pages.assets.helpers import downloadFutures, updateFutures
...
class FutureHistoryTablePage(BasePage):
    ...
    def __init__(self, **kwargs: Any):
        ...
        # load template
        uic.loadUi(
            "src/ui/windows/asset_detail/futures/pages/history_table/history_table.ui",
            self,
        )

        # load styles
        with open(
            "src/ui/windows/asset_detail/futures/pages/history_table/history_table.qss",
            "r",
        ) as fh:

...
from src.ui.windows.asset_detail.shared.pages.contract_details.table import CDTable
...
class ContractDetailsPage(BasePage):
    ...
    def __init__(self, **kwargs: Any):
        ...
        # load template
        uic.loadUi(
            "src/ui/windows/asset_detail/shared/pages/contract_details/contract_details.ui",
            self,
        )

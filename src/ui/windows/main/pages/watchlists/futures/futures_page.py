...
from src.business.modules.futures_watchlist_bl import FuturesWatchlistBL
...
from src.ui.windows.main.pages.watchlists.futures.table.tree import FuturesTree
from src.ui.windows.main.pages.watchlists.futures.table.tree_model import (
    FuturesTreeNode,
)
from rx.core.typing import Disposable
from src.helpers import constructKey
...
class FuturesWatchlistPage(BasePage):
    ...
    def __init__(self, *args: Tuple[str, Any], **kwargs: Dict[str, Any]):
        ...
        # load template
        uic.loadUi(
            "src/ui/windows/main/pages/watchlists/futures/futures_page.ui", self
        )

        # load styles
        with open(
            "src/ui/windows/main/pages/watchlists/futures/futures_page.qss", "r"
        ) as fh:

...
from src.ui.windows.main.pages.watchlists.futures.table.item_delegate import (
    MyRenderDelegate,
)
from src.ui.windows.main.pages.watchlists.futures.table.tree_model_new import (
    FuturesTreeModel,
)
...
class FuturesTree(QTreeView):
    ...
    def __init__(self):
        ...
        # load styles
        with open(
            "src/ui/windows/main/pages/watchlists/futures/table/tree.qss", "r"
        ) as fh:

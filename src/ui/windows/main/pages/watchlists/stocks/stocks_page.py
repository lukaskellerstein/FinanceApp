...
from src.business.modules.stocks_watchlist_bl import StocksWatchlistBL
...
class StocksWatchlistPage(BasePage):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # load template
        uic.loadUi(
            "src/ui/windows/main/pages/watchlists/stocks/stocks_page.ui", self
        )

        # load styles
        with open(
            "src/ui/windows/main/pages/watchlists/stocks/stocks_page.qss", "r"
        ) as fh:
